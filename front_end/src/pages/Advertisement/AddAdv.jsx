...
export default function AddAdv() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!document.getElementById('image').files.length) newErrors.image = 'Main image is required';
    if (!document.getElementById('images').files.length) newErrors.images = 'At least one additional image is required';
            ...
            <div className={`container ${styles.hoverableCard}`} style={{ border: '1px solid #dee2e6', margin: 'auto', width: '90%' }}>
              <form className="needs-validation" method="POST" onSubmit={handleSubmit} encType="multipart/form-data">
                ...
                <div id="billingAddress" className="row g-4">
                  ...
                  <label htmlFor="specification" style={{ marginBottom: '-15px' }}>Specification</label>
                  {inputGroups.map((inputGroup, index) => (
                    <div className="col-md-12" key={index}>
                      ...
                      {index === inputGroups.length - 1 && !inputGroup.attribute && !inputGroup.value && errors.specification && (
                        <span className="text-danger mt-3">{errors.specification}</span>
                      )}
                    </div>
                  ))}
                  <div className="col-md-12">
                    <label htmlFor="description" className="form-label">Description</label>
                    <textarea className="form-control form-control3" id="description" name="description" />
                  ...
                  <div className="col-md-6">
                    ...
                    <input type="file" className="form-control form-control3" id="image" name="image" required="" accept="image/png, image/jpeg" />
                  ...
                  <div className="col-md-6">
                    ...
                    <input type="file" className="form-control form-control3" id="images" name="images" accept="image/png, image/jpeg" multiple />
